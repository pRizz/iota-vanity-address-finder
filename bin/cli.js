...
const chanceOfFindingOneCharVanityStringOnFirstTry = 1 / 81
...
function main() {
  ...
  vanityString = vanityString.toUpperCase()

  if(!Common.isValidVanityString({ vanityString })) {
    console.error(`Error: must supply a vanity string that consists of trytes [A-Z9] and not be greater than ${Common.maxVanityLength} trytes!`)
    program.help()
  }
